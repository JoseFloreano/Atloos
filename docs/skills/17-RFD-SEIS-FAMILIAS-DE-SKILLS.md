...
| **4** | Bases de datos | **Parcial: 5 de 17** | Las 5 de S0, con los cuerpos entre 468 y 499 palabras sobre un tope de 500 (§4.4) y **0–1 `references/`** | No es "crear más": es **auditar las 5 vivas** y decidir qué queda del catálogo muerto |
