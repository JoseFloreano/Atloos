...
| ~~09 · Higiene de contexto y ciclo de vida del vault~~ | ✅ **Implementado, auditado y cosechado** (2026-08-01) → la decisión vive en `ADR-20260801-higiene-vault` del vault. Tope de `_PROJECT.md`, índice de ADRs, ciclo de los RFDs. **Lo medido:** el arranque leía ~36 KB del vault y el 39 % de `_PROJECT.md` era historial; quedó en **7 861 B de suelo** y `_PROJECT.md` de **188 a 106 líneas**, sin perder una nota. Su prompt derivado se cosechó y podó el 2026-08-19 (en git); los dos errores durables subieron a `skill-forge/references/disparadores.md` |
